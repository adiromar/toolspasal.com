...
<link rel="canonical" href="{{'https://www.sastoshowroom.com/supplier/'.$user->id.'/'.$user->name }}" />
@endsection
...
.off{ position:absolute;top:34px;right:19px;background-color:#dc2727;color:white;padding-left:8px;padding-right:8px;padding-top: 2px;
	padding-bottom: 2px;font-size: 14px; }
.profile-header img{
	object-fit: cover;min-height: 285px;
}
.offer-img-profile{
	margin: 30px 0px;
...
<div class="container">
	<div class="row">
		<div class="col-md-3" style="padding: 5px; border: 1px solid #f5d9d982;">
			<img src="{{ url('uploads/suppliers/'.$user->profile->image) }}" alt="" width="100%">
		</div>

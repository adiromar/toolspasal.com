			              ...
			              <div class="col-md-12">
			                <div class="delivery_charge">
			                  <div class="row">
								...
								<div class="col-md-6">
									<a href="{{ url('/category/'. str_slug($product->categoryName) ) }}"><small>{{ $product->categoryName }}</small></a>
								</div>
			                  	<div class="col-md-12">
				...
				<div class="col-md-12 offset-md-3 padding-review">
					...
					<p>
						...
						<form action="{{ route('product.review') }}" method="post" class="pl-2">
							...
							<textarea name="reviewDesc" id="" rows="4" class="form-control" placeholder="Your Review"></textarea>

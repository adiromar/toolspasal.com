        ...
        <div class="col-md-9">
        	<div class="card">
              <div class="card-body">
                ...
                <form action="{{ route('managesuppliers.store') }}" method="post" enctype="multipart/form-data">
					{{ csrf_field() }}				
					...
					<div class="form-group">
	                	...
	                	<textarea name="about_us" class="form-control" cols="30" rows="3">{{ old('about_us') }}</textarea>
					</div>

					<div class="form-group">
						<label for="">Contact Email:</label>
	                	<input type="email" name="contactEmail" class="form-control" value="{{ Auth::user()->email }}">
					</div>
